  ...
  for (const auto& element : beamline)
    {
      ...
      std::set<GMAD::ElementType> acceptedTypes = {GMAD::ElementType::_ECOL,
						   ...
						   GMAD::ElementType::_RFX,
						   GMAD::ElementType::_RFY,
						   GMAD::ElementType::_SOLENOID,
						   GMAD::ElementType::_HKICKER,
						   GMAD::ElementType::_VKICKER,
						   GMAD::ElementType::_KICKER,
						   GMAD::ElementType::_TKICKER,
						   GMAD::ElementType::_TARGET,
						   GMAD::ElementType::_DUMP,
						   GMAD::ElementType::_SHIELD,
						   GMAD::ElementType::_DEGRADER,
						   GMAD::ElementType::_GASCAP,
						   GMAD::ElementType::_GASJET,
						   GMAD::ElementType::_SCREEN,
						   GMAD::ElementType::_WIRESCANNER,
						   GMAD::ElementType::_JCOLTIP,
